...
void loop() {
  ...
  //for (int ms = 1200; ms < 1800; ms += 1) {
  //  board1.writeMicroseconds(0, ms);
  //  Serial.println(ms);
  // delay(20);
  //}

  // for (int ms = 1300; ms < 1700; ms += 10) {  //rack and pinion1 works only in 1 direction
  //   board1.writeMicroseconds(0, ms);
  //   Serial.println(ms);
  //   delay(1000);
  // }

  // for (int ms = 930; ms < 1300; ms += 10) {  // rack and pinion 
  //   board1.writeMicroseconds(0, ms);
  //   Serial.println(ms);
  //   delay(1000);
  // }
  // board1.writeMicroseconds(0, 1100);
  // delay(100);
  //range .93-1.3, deadzone at 1.13ms

  // for (int ms = 1300; ms < 1900; ms += 10) {  //winches 
  //   board1.writeMicroseconds(0, ms);
  //   Serial.println(ms);
  //   delay(1000);
  // }
  board1.writeMicroseconds(0, 1750);
  delay(100);

  //range 1.3-1.7 -> one direction, 1.7-? -> other direction (max probably 2.2)
  //speed 1.3-1.6 and 1.8-1.9 -> about same speed
